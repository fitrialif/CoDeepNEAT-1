...
from keras_funcs import makeKeras, makeKerasGivenMods, setupCIFAR, runCIFAR
...
if __name__ == '__main__':
    print "\n--- Starting CIFAR-10 Experiment for CoDeepNEAT project --- \n"
    sys.stdout.flush()
    ...
    picDir = os.path.join(os.getcwd(), "cifar10/pics/")
    pickleDir = os.path.join(os.getcwd(), "cifar10/pickles/")
