...
# node_gene_type = genes.NodeGene
conn_gene_type = genes.ConnectionGene
...
if __name__ == '__main__':
    ...
    node_gene_type = genes.NodeGene         # standard neuron model
    conn_gene_type = genes.ConnectionGene   # and connection link
